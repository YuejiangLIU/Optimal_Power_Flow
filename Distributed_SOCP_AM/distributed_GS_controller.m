...
fprintf('Optimal value (Consensus GS): %f \n', objTotal(end));
fprintf('Exactness (Consensus GS): [%f %f]\n', x_check);
...
solfile = strcat('GS_sol_consensus_predication_time_',num2str(t0),'_rho_',num2str(rho),'_nsub_',num2str(Nmilestone),'.mat');
