...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       BCD-based distributed opf controller 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
plot(t,[p_station p_station(1)],'--d',...
    ...
    t,batTotal,'--o');
title(strcat('BCD Predication at Time',num2str(t0),' (Battery Capacity = ',num2str(mpc.B_upbound*Nbus),' p.u.)'));
xlabel('Time (Hour)');
ylabel('Power (p.u.)');
...
fprintf('Optimal value (Consensus BCD): %f \n', objTotal(end));
fprintf('Exactness (Consensus BCD): [%f %f]\n', x_check);
...
solfile = strcat('BCD_sol_consensus_predication_time_',num2str(t0),'_rho_',num2str(rho),'.mat');
